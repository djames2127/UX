...
export function mainAnimateUp() {
  ...
  currentSection.previousElementSibling.classList.add('section-animation');
  ...
  setTimeout(() => {
    ...
    document.querySelector('.top-section').classList.remove('section-animation');
  }, 1190)
